...
/**
 * list_replace_init - replace old entry by new_head one and initialize the old one
 * @old : the element to be replaced
 * @new_head : the new_head element to insert
 *
 * If @old was empty, it will be overwritten.
 ...
 * @list: The desired new_head front of the list.
 * @head: The head of the list.
 *
 * Rotates list so that @list becomes the new_head front of the list.
 */
...
/**
 * hlist_add_head - add a new_head entry at the beginning of the hlist
 * @n: new_head entry to be added
...
/**
 * hlist_add_before - add a new_head entry before the one specified
 * @n: new_head entry to be added
...
/**
 * hlist_add_behind - add a new_head entry after the one specified
 * @n: new_head entry to be added
 ...
 * @new_head: hlist_head for new_head list.
 *
